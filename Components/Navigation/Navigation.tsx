...
const Navigation = () => {
  ...
  return (
    <View style={style.NavigationContainer}>
      <TouchableOpacity style={style.IconContainer} onPress={() => Navigate(1)}>
        <>
          <IconEntypo
      ...
      <TouchableOpacity style={style.IconContainer} onPress={() => Navigate(2)}>
        <>
          <IconMaterial
      ...
      <TouchableOpacity style={style.IconContainer} onPress={() => Navigate(3)}>
        <>
          <IconFontAwesome5
      ...
      <TouchableOpacity style={style.IconContainer} onPress={() => Navigate(4)}>
        <>
